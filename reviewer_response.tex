...
A new paragraph has been added to the end of the section ``Early Foundations: The Jet Drop Mechanism'' introducing film-drop formation, its role in producing submicron SSA, and its historical significance, with reference to a recent fluid-mechanical review.
...
The concluding discussion has been revised to emphasise size-resolved fluxes, mixing states, activation properties, and number fluxes. In addition, the new section ``Critical Uncertainties for Climate Applications'' explicitly states that, for cloud droplet formation, the physical production flux, size distribution, and number concentration of SSA may often exert a stronger control than biologically mediated changes in primary chemical composition.
...
I agree that film drops are a fundamental pathway for sea-spray aerosol production and that the distinction between jet drops and film drops should be introduced earlier in the manuscript. I have therefore revised the early historical section to explicitly discuss film-drop formation during rupture of the bubble cap, its importance for submicron SSA production, and the continued relevance of the jet-drop/film-drop distinction for understanding aerosol size distributions. I have also added the suggested reference to the recent review by \citet{Deike2022}, which provides a valuable synthesis of the fluid-mechanical aspects of sea-spray aerosol production.

\textbf{Changes made:}

A new paragraph has been added to the section ``Early Foundations: The Jet Drop Mechanism'' discussing film-drop production, the different particle size classes associated with jet and film drops, and the relevance of recent fluid-mechanical work, including \citet{Deike2022}.
...
The discussion of organic enrichment and biological control has been revised to more explicitly distinguish between studies showing strong local biological influence and studies showing weak seasonal or open-ocean variability. I have added text explaining that these apparently conflicting observations may reflect differences in the timing and microbial transformation of biogenic material, and that chlorophyll-a is an incomplete proxy for SSA composition because it does not capture the microbial processing that governs whether organic material becomes aerosolisable. I have also expanded the discussion of mesocosm and controlled-bloom studies to highlight bloom phase, heterotrophic bacterial activity, cell lysis, grazing, and viral processes as controls on organic enrichment.

In addition, I have added a new section, ``Critical Uncertainties for Climate Applications'', which identifies the uncertainties most relevant for models and climate applications. This section discusses the relationship between SSA composition and CCN activity, the importance of size-resolved number fluxes, the complex response of SSA production to sea-surface temperature, and the need for source functions that represent coupled controls including wave breaking, bubble-plume dynamics, SST, salinity, surfactants, and biologically mediated changes in seawater composition.
...
Section 3 (``The Whitecap Era: Empirical Parameterisations'') now includes the Monahan et al. (1986) formulation,
\[
\frac{dF_0}{dr}=W(U)\tau^{-1}\frac{dE}{dr},
\]
together with the empirical whitecap-coverage relationship,
\[
W(U)=3.84\times10^{-6}U^{3.41}.
\]
The surrounding text has also been revised to explain how this formulation linked wind speed, whitecap coverage, and aerosol productivity in a form suitable for regional and global modelling studies.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.75\textwidth]{images/Blanchard_Figure_4_redrawn.pdf}
    \caption*{Redrawn version of Figure 2 based on data digitised from Figure 4 of \citet{Blanchard1957}.}
\end{figure}
